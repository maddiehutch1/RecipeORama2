...
final class Recipe {
    ...
    init(title: String, ingredients: String, instructions: String, author: String, timeToMake: String, servings: String, tags: String, difficultyLevel: String, isFavorite: Bool) {
        self.title = title
